...
def build_model(word_types, pos_types, outputs):
    ...
    model = tensorflow.keras.Sequential(
        [
            tensorflow.keras.layers.Embedding(input_dim=word_types, output_dim=32, input_length=6),
    ...
    model.compile(tensorflow.keras.optimizers.Adam(lr=0.01), loss="categorical_crossentropy")
    return model
